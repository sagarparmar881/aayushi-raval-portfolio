...
const routes = [
	...
	},
	{
		...
		meta: {
			title: 'Project - AR Enteprises Vapi',
		},
	},
	{
		path: '/projects/license-plate',
		...
		meta: {
			title: 'Project - License Plate',
		},
	},
	{
		path: '/projects/web-scrapping',
		name: 'Web Scrapping',
		// route level code-splitting
		// this generates a separate chunk (projects.[hash].js) for this route
		// which is lazy-loaded when the route is visited.
		component: () =>
			import(
				/* webpackChunkName: "projects" */ '../views/WebScrapping.vue'
			),
		meta: {
			title: 'Project - Web Scrapping',
		},
	},
	{
		...
		meta: {
			title: 'Project - Navrachana Uiversity',
		},
	},
	{
		path: '/contact',
